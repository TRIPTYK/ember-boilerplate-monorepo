import { entities, AuthModule, RefreshTokenEntity } from "#src/index.js";
import type { FastifyInstanceTypeForModule } from "#src/init.js";
import { TestUserEntity } from "./test-user-entity.js";
...
export class TestModule {
  ...
  public static async init() {
    ...
    const module = AuthModule.init({
      em: sharedEm,
      userRepository: sharedEm.getRepository(TestUserEntity),
      configuration: {
        jwtSecret: TestModule.JWT_SECRET,
        jwtRefreshSecret: TestModule.JWT_REFRESH_SECRET,
        appName: "Registr",
        emailFromAddress: "no-reply@registr.com",
  ...
  public async createUser(data: {
    ...
    await this.em.getRepository(TestUserEntity).insert({
      ...data,
